          ...
          children: <Widget>[
            ...
            Positioned(
              ...
              child: InkWell(
                onTap: () {},
                child: Container(
                  child:Center(child: firstwidget),
            ...
            Positioned(
              ...
              child: Container(
                child: Center(child: thirdwidget),
                decoration: BoxDecoration(
                    color: color, borderRadius: BorderRadius.circular(50)),
                width: 65,
                height: 65,
            ...
            Positioned(
              ...
              child: Container(
                child:Center(child: fourthwidget),
                decoration: BoxDecoration(
                    color: color, borderRadius: BorderRadius.circular(50)),
                width: 65,
                height: 65,
            ...
            Positioned(
              ...
              child: Container(
                child: Center(child: fivthwidget),
                decoration: BoxDecoration(
                    color: color, borderRadius: BorderRadius.circular(50)),
                width: 65,
                height: 65,
            ...
            Positioned(
              ...
              child: Container(
                child: Center(child: sixthwidget),
                decoration: BoxDecoration(
                    color: color, borderRadius: BorderRadius.circular(50)),
                width: 65,
                height: 65,
            ...
            Positioned(
              ...
              child: Container(
                child: Center(child: seventhwidget),
                decoration: BoxDecoration(
                    color: color, borderRadius: BorderRadius.circular(50)),
                width: 65,
                height: 65,
